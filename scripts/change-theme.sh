...
dark_theme() {
  ...
  sed -i "s/\"workbench.colorTheme\": \"Material Theme Lighter\",/\"workbench.colorTheme\": \"Material Theme Ocean\",/g" /home/tim/.config/Code/User/settings.json
  sed -i "s/\"workbench.colorTheme\": \"Material Theme Lighter\",/\"workbench.colorTheme\": \"Material Theme Ocean\",/g" /home/tim/.var/app/com.visualstudio.code/config/Code/User/settings.json
...
light_theme() {
  ...
  sed -i "s/\"workbench.colorTheme\": \"Material Theme Ocean\",/\"workbench.colorTheme\": \"Material Theme Lighter\",/g" /home/tim/.config/Code/User/settings.json
  sed -i "s/\"workbench.colorTheme\": \"Material Theme Ocean\",/\"workbench.colorTheme\": \"Material Theme Lighter\",/g" /home/tim/.var/app/com.visualstudio.code/config/Code/User/settings.json
