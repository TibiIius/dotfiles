...
dark_theme() {
  ...
  sed -i "s/\"workbench.colorTheme\": \"Material Theme Lighter\",/\"workbench.colorTheme\": \"Horizon\",/g" /home/tim/.var/app/com.visualstudio.code/config/Code/User/settings.json
...
light_theme() {
  ...
  sed -i "s/\"workbench.colorTheme\": \"Horizon\",/\"workbench.colorTheme\": \"Material Theme Lighter\",/g" /home/tim/.var/app/com.visualstudio.code/config/Code/User/settings.json
